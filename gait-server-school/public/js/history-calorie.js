    ...
    created: function() {
        ...
        deviceRequest.getJSON(function (res) {
            if ( res.successful == true ){
                ...
                var request = new HttpRequest('/device/' + self.device.id + '/history/calories');
                request.getJSON(function(res) {
                    if(res.successful == true){
                        var calorieList = res.data.calories
                        $('#myLoading').hide();
                        $('#page-wrapper').show();
...
Wechat.login(function(result) {
    ...
    request.getJSON(function(res) {
        if(res.successful == false) {
            var historyCaloriePage = new Vue(historyCaloriePageClass);
